...
class ShopCashierLogin(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.user_code = cashier_info['usercode']
        cls.password = cashier_info['password']
...
if __name__ == '__main__':
    ...
    # 收银员登录
    suite.addTest(ShopCashierLogin("test_find_element_index"))
    suite.addTest(ShopCashierLogin("test_find_element_receive_money"))
    suite.addTest(ShopCashierLogin("test_vip_list_search"))
