...
"""
-------------------------------------------------
   File Name：     test_caibao4_shopcashier
   Description :
   Author :        Meiyo
...
class ShopCashierLogin(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_1_shop_manager_login(self):
        ...
        cashier_info = content.get('CashierInfo')
        merchant_code = merchant_info['merchant_code']
        user_code = cashier_info['usercode']
        password = cashier_info['password']
...
if __name__ == '__main__':
    ...
    # 收银员登录
    suite.addTest(ShopCashierLogin("test_1_shop_manager_login"))
    suite.addTest(ShopCashierLogin("test_2_find_element_index"))
    suite.addTest(ShopCashierLogin("test_3_find_element_receive_money"))
    suite.addTest(ShopCashierLogin("test_4_vip_list_search"))
    suite.addTest(ShopCashierLogin("test_5_shop_manager_logout"))
